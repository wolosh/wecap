...
export class SessionService {
  ...
  public addComentario(form, token) {
    //console.log(form)
    //console.log(idUser,  token)
    const headers = new HttpHeaders({
      'Authorization': `Bearer ${token}`,
    ...
    return this.http.post(`${this.API}addComentario`, form, {
      headers,
    }).pipe(
      catchError((err) => {
        console.log(err);
  ...
  public asignaTemas(form, token) {
    ...
    return this.http.post(`${this.API}asignaTemas`, form, {
      headers,
    }).pipe(
      catchError((err) => {
        console.log(err);
  ...
  public editConferencia(id, form, token) {
    //console.log(form)
    //console.log(idUser,  token)
    const headers = new HttpHeaders({
      'Authorization': `Bearer ${token}`,
    ...
    return this.http.post(`${this.API}editConferencia/${id}`, form, {
      headers,
    })/*.pipe(
      catchError((err) => {
        console.log(err);
